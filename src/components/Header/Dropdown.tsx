...
const Dropdown = () => {
  return (
    <div className="border border-[#182536] fixed right-10 top-[66px] rounded-md text-white w-[300px] z-10 flex flex-col">
      <div className="flex items-center gap-3 cursor-pointer bg-[#101924] p-5 border-b border-[#8092AB]">
